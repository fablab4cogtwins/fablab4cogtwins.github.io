  ...
  <div class="row justify-content-center">
    <div class="col-lg-10">
      <div class="text-center mb-5">
        <h1 class="fw-bold text-primary mb-3">土壤剖面监测与精准灌溉系统</h1>
        <div class="d-flex justify-content-center">
          <span class="badge bg-gradient-primary rounded-pill px-3 py-2 me-2">RS485 Modbus</span>
          <span class="badge bg-gradient-success rounded-pill px-3 py-2">ESP32-C3-Pro</span>
          <span class="badge bg-gradient-info rounded-pill px-3 py-2">精准农业</span>
        </div>
      </div>
          ...
          <div class="card border-0 shadow-lg rounded-4 overflow-hidden mb-4">
            ...
            <div class="card-body p-5">
              <p class="fs-5 text-dark mb-0">
                本项目针对传统土壤监测信号漂移、垂直数据缺失等痛点，研发了一款基于工业RS485 Modbus架构的土壤剖面监测系统。该方案能连续采集根区数据，辅助灌溉与施肥判断，可适用于温室、大田及植物工厂等场景。
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="card-body p-4">
              <div class="d-flex align-items-center mb-4">
                ...
                <div>
                  ...
                  <div class="fw-bold fs-5">2026年3月</div>
                </div>
              </div>
              ...
              <div class="d-flex align-items-center mb-4">
                ...
                <div>
                  ...
                  <div class="fw-bold fs-5">物联网与精准农业</div>
                </div>
              </div>
              ...
              <div class="d-flex align-items-center">
                ...
                <div>
                  ...
                  <div class="fw-bold fs-5">原型开发阶段</div>
                </div>
              </div>
            </div>
          </div>
