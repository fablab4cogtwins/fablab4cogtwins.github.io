  ...
  <div class="row justify-content-center">
    <div class="col-lg-10">
      <div class="text-center mb-5">
        <h1 class="fw-bold text-primary mb-3">缺失检测机器人</h1>
        <div class="d-flex justify-content-center">
          <span class="badge bg-gradient-primary rounded-pill px-3 py-2 me-2">智能检测</span>
          <span class="badge bg-gradient-success rounded-pill px-3 py-2">自动化系统</span>
        </div>
      </div>
          ...
          <div class="card border-0 shadow-lg rounded-4 overflow-hidden mb-4">
            ...
            <div class="card-body p-5">
              <p class="fs-5 text-dark mb-4">
                本项目开发了一套自动化缺失检测系统，用于实时检测箱体是否缺少零部件。
              </p>
              <p class="fs-5 text-dark mb-0">
                该系统可广泛应用于工业生产线、仓储物流等场景，提高产品质量检测效率和准确性。
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="card-body p-4">
              ...
              <div class="d-flex align-items-center mb-4">
                ...
                <div>
                  ...
                  <div class="fw-bold fs-5">机器人系统与智能检测</div>
                </div>
              </div>
              ...
              <div class="d-flex align-items-center">
                ...
                <div>
                  ...
                  <div class="fw-bold fs-5">研发阶段</div>
                </div>
              </div>
            </div>
          </div>
