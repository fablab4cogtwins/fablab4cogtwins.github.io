  ...
  <div class="row justify-content-center">
    <div class="col-lg-10">
      <div class="text-center mb-5">
        <h1 class="fw-bold text-primary mb-3">电风扇防夹手安全控制系统</h1>
        <div class="d-flex justify-content-center">
          <span class="badge bg-gradient-primary rounded-pill px-3 py-2 me-2">安全防护</span>
          <span class="badge bg-gradient-success rounded-pill px-3 py-2">智能控制</span>
        </div>
      </div>
          ...
          <div class="card border-0 shadow-lg rounded-4 overflow-hidden mb-4">
            ...
            <div class="card-body p-5">
              <p class="fs-5 text-dark mb-0">
                本项目针对电风扇产品在摇头机构等关键部位存在的夹手安全隐患，设计了一种低成本、可后装、不改变风扇原有机械外观结构的智能安全防护系统。
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="card-body p-4">
              ...
              <div class="d-flex align-items-center mb-4">
                ...
                <div>
                  ...
                  <div class="fw-bold fs-5">安全控制系统</div>
                </div>
              </div>
