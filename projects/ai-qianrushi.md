  ...
  <div class="row justify-content-center">
    <div class="col-lg-10">
      <div class="text-center mb-5">
        <h1 class="fw-bold text-primary mb-3">智能家电芯片与集成系统</h1>
        <div class="d-flex justify-content-center">
          <span class="badge bg-gradient-primary rounded-pill px-3 py-2 me-2">情感交互</span>
          <span class="badge bg-gradient-success rounded-pill px-3 py-2">心理健康</span>
          <span class="badge bg-gradient-info rounded-pill px-3 py-2">AI芯片</span>
        </div>
      </div>
            ...
            <div class="card-body p-4">
              ...
              <div class="d-flex align-items-center mb-4">
                ...
                <div>
                  ...
                  <div class="fw-bold fs-5">芯片与集成系统</div>
                </div>
              </div>
