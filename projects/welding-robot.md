  ...
  <div class="row justify-content-center">
    <div class="col-lg-10">
      <div class="text-center mb-5">
        <h1 class="fw-bold text-primary mb-3">焊接机器人</h1>
        <div class="d-flex justify-content-center">
          <span class="badge bg-gradient-primary rounded-pill px-3 py-2 me-2">高精度</span>
          <span class="badge bg-gradient-success rounded-pill px-3 py-2">自动化</span>
        </div>
      </div>
          ...
          <div class="card border-0 shadow-lg rounded-4 overflow-hidden mb-4">
            ...
            <div class="card-body p-5">
              <p class="fs-5 text-dark mb-0">
                本项目研发了一套焊接机器人系统，旨在通过集成视觉与激光技术，实现图形的高精度校准与实时投射。
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="card-body p-4">
              ...
              <div class="d-flex align-items-center mb-4">
                ...
                <div>
                  ...
                  <div class="fw-bold fs-5">机器人系统</div>
                </div>
              </div>
